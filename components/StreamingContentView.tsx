      ...
      <div className={`overflow-y-auto text-left pr-2 flex-1 min-h-0 ${fullHeight ? '' : 'max-h-[600px]'}`}>
        {!content ? (
          <div className="flex flex-col items-center justify-center h-full min-h-[350px] text-center p-6 text-zinc-500">
            <div className="w-10 h-10 rounded-lg bg-zinc-800/80 border border-zinc-700 text-zinc-400 flex items-center justify-center mb-3">
            ...
            <div className="flex items-center gap-2 text-[11px] font-mono text-zinc-400 bg-zinc-950 border border-zinc-800 px-3 py-1 rounded-full">
