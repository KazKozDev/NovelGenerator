...
export const ThreeZoneGenerationView: React.FC<ThreeZoneGenerationViewProps> = ({
  ...
  return (
    <div className="w-full flex flex-col gap-6 animate-fade-in text-zinc-200">
      {/* Top Header & Global Controls */}
      <div className="bg-zinc-900/80 border border-zinc-800 rounded-xl p-4 md:p-5 shadow-sm">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
          <div className="flex items-center gap-3">
            <div className="p-2.5 rounded-lg bg-zinc-800 border border-zinc-700 text-zinc-400">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-base font-semibold text-zinc-100 tracking-tight">Author Studio</h2>
          ...
          <div className="flex items-center gap-3">
            {isLoading && (
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-zinc-800/80 border border-zinc-700 text-zinc-300 text-xs font-mono">
                <LoadingSpinner className="!my-0 !h-4 !w-4" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start w-full">
        ...
        <div
          ...
          className="lg:col-span-3 flex flex-col gap-4 bg-zinc-900/80 border border-zinc-800 rounded-xl p-4 shadow-sm text-left"
        >
              ...
              {Array.from({ length: Math.max(totalChaptersToProcess, generatedChapters.length) }).map((_, idx) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center justify-between p-2.5 rounded-lg text-xs transition-colors text-left w-full border ${
                      isSelected
          ...
          <div className="border-t border-zinc-800 pt-4 flex flex-col gap-2">
            <button
              ...
              className="flex items-center justify-between text-[11px] font-semibold uppercase tracking-wider text-zinc-400 hover:text-zinc-200 transition-colors"
            >
        ...
        >
          {isWritingProse || activeContent ? (
            ...
            <div className="p-8 bg-zinc-900/80 border border-zinc-800 rounded-xl shadow-sm flex flex-col items-center justify-center text-center h-full min-h-[500px]">
        ...
        <div
          ...
          className="lg:col-span-3 flex flex-col gap-4 bg-zinc-900/80 border border-zinc-800 rounded-xl p-4 shadow-sm text-left max-h-[85vh] overflow-y-auto"
        >
          <div className="flex items-center justify-between border-b border-zinc-800 pb-3">
            <div className="flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-zinc-400" />
          ...
          <div className="grid grid-cols-2 gap-2 text-xs font-mono">
            <div className="p-2.5 bg-zinc-950 rounded-lg border border-zinc-800">
              ...
              <div className="text-zinc-300 font-medium mt-0.5 flex items-center gap-1.5">
            ...
            <div className="p-2.5 bg-zinc-950 rounded-lg border border-zinc-800">
              ...
              <div className="text-zinc-300 font-medium mt-0.5 truncate">
          ...
          {agentLogs.length > 0 ? (
            ...
            <div className="text-center py-12 text-zinc-500 text-xs flex flex-col items-center gap-2 font-mono">
