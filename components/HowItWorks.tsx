...
const HowItWorks: React.FC = () => {
  return (
    <div className="mb-8 p-6 border border-zinc-800 bg-zinc-900/60 rounded-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <span className="flex items-center justify-center w-7 h-7 rounded-sm bg-zinc-800 border border-zinc-700 text-zinc-300 font-mono font-medium text-xs">
              01
            </span>
      ...
      <div className="mt-6 p-3 bg-zinc-950 border border-zinc-800 rounded-sm">
