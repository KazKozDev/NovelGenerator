        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6">
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-zinc-950 border border-zinc-700 rounded-md text-zinc-100 placeholder-zinc-500 text-sm focus:outline-none focus:ring-1 focus:ring-zinc-400 focus:border-zinc-400"
              autoFocus
            />
          </div>
          <div className="flex justify-end gap-3 p-4 bg-zinc-950/60 border-t border-zinc-800/80 rounded-b-lg">
            <Button
              type="button"
              onClick={onCancel}
              variant="secondary"
