...
STATE A FACT IN THE AFFIRMATIVE. "Not X, but Y" — defining a thing, a feeling or an act by first denying what it is not — is earned only where someone on the page held the denied belief and events are correcting them. It hides across a sentence break: "It was not a handshake. It was a grip." is the same device, and a reader who has met it three times predicts the second sentence before reading it. As a default way to describe, it becomes a tic audible within a page and doubles the length of every description. Where nothing is being corrected, delete the denial and write what is there.
...
WHAT A CHARACTER CANNOT DO, THEY DO NOT DO. The limits in the character design hold for the whole scene, the body's ceiling and the standing refusal alike. Break one only by paying for it on the page: the character chooses it, the prose shows the cost. An ordinary hand does not tear what bullets do not, and a man who does not kill does not let a death buy him an advantage.
